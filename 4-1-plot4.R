...
with(data2, {
    plot(joined_date, Global_active_power, type = 'l', xlab = "",
         ylab = 'Global Active Power (kilowatts)')
    plot(joined_date, Sub_metering_1, type = 'l', xlab = "",
    ...
    plot(joined_date, Voltage, type = 'l', xlab = 'datetime')
    plot(joined_date, Global_reactive_power, type = 'l', xlab = 'datetime')
})
